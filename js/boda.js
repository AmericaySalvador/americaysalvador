...
function sendWhatsapp() {
  ...
  if (document.getElementById("email").value == "") {
    Swal.fire({
      title: '',
      html: '<img src="americaysalvador/image/ays/favorites/s.jpg" style="width: 50%; height: 70%; "><h2 style="color: black;font-family: \'Montserrat\', sans-serif; ">Ingresa tu correo</h2>',
      background: 'rgba( 251, 250, 249,30.1)',
      confirmButtonText: 'Ok',
      confirmButtonColor: '#000000',
    })
  ...
  if (document.getElementById("phone").value == "") {
    Swal.fire({
      title: '',
      html: '<img src="americaysalvador/image/ays/favorites/s.jpg" style="width: 50%; height: 70%;"><h2 style="color: black;font-family: \'Montserrat\', sans-serif; ">Ingresa tu Numero de Telefono</h2>',
      background: 'rgba( 251, 250, 249,30.1)',
      confirmButtonText: 'Ok',
      confirmButtonColor: '#000000',
    })
  ...
  if (document.getElementById("guest").value == "") {
    Swal.fire({
      title: '',
      html: '<img src="americaysalvador/image/ays/favorites/s.jpg" style="width: 50%; height: 70%;"><h2 style="color: black; font-family: \'Montserrat\', sans-serif; ">Parece que no estas invitado</h2>',
      background: 'rgba( 251, 250, 249,30.1)',
      confirmButtonText: 'Ok',
      confirmButtonColor: '#000000',
    })
